...
import styles from "./TheoDoiHongMat.module.scss";
...
function TheoDoiHongMat() {
    ...
    useEffect(() => {
        const fetchDevices = async () => {
            if (!isSearching) {
                const dataResponse = await getServices.getTheoDoiHongMatPage(
                    page,
                    size
                );
    ...
    return (
        <div className={cx("wrapper", "col-11")}>
            ...
            <p>Quản lý thiết bị &gt; Theo dõi hỏng mất</p>
            ...
            <div className="row m-0">
                ...
                <Link
                    ...
                    to={config.routes.khai_bao_hong_mat}
                >
                    <div>Khai báo</div>
                </Link>
                <Table
